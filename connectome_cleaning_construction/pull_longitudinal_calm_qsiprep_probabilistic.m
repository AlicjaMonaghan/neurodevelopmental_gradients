...
% written by danyal akarca and adapted for calm II by alicja monaghan.
clear; clc;
% set qsiprep directory
qsiprepDir = '/imaging/astle/users/da04/Postdoc/qsiprep_optimise/calm_2_csd_ACT/final_output/';
...
%% set labels
% parcellation labels
parcellations = string(['aal116','aicha384','brainnetome246',...
...
calm_qsiprep = struct();
% sample
calm_qsiprep.sample.id.sub = {sub_id_structure.name}';
% info
calm_qsiprep.info.datatypes = datatypes';
calm_qsiprep.info.meta = 'all parcellated data is in the order: subject, data type, data';
calm_qsiprep.info.parcellations = parcellations';
% quality control
calm_qsiprep.qc.framedisplacement = framedisplace;
calm_qsiprep.qc.summary = qcsummary;
calm_qsiprep.qc.summarylabels = qclabels';
% dti data
% aal116
calm_qsiprep.aal116.coordinates = aal116_coordinates;
calm_qsiprep.aal116.connectivity = aal116;
calm_qsiprep.aal116.hemi = aal116_hemi;
calm_qsiprep.aal116.lobe = aal116_lobe;
calm_qsiprep.aal116.regionlabels = string(aal116_region_labels);
% aicha384
calm_qsiprep.aicha384.coordinates = aicha384_coordinates;
calm_qsiprep.aicha384.connectivity = aicha384;
calm_qsiprep.aicha384.regionlabels = string(aicha384_region_labels);
calm_qsiprep.aicha384.volume = aicha384_volume;
% brainnetome246
calm_qsiprep.brainnetome246.coordinates = brainnetome246_coordinates;
calm_qsiprep.brainnetome246.connectivity = brainnetome246;
calm_qsiprep.brainnetome246.hemi = brainnetome246_hemi;
calm_qsiprep.brainnetome246.lobe = brainnetome246_lobe;
calm_qsiprep.brainnetome246.regionlabels = string(brainnetome246_region_labels);
% gordon333
calm_qsiprep.gordon333.coordinates = gordon333_coordinates;
calm_qsiprep.gordon333.connectivity = gordon333;
calm_qsiprep.gordon333.hemi = gordon333_hemi;
calm_qsiprep.gordon333.lobe = gordon333_lobe;
calm_qsiprep.gordon333.regionlabels = string(gordon333_region_labels);
% power264
calm_qsiprep.power264.coordinates = power264_coordinates;
calm_qsiprep.power264.connectivity = power264;
calm_qsiprep.power264.hemi = power264_hemi;
calm_qsiprep.power264.lobe = power264_lobe;
calm_qsiprep.power264.regionlabels = string(power264_region_labels);
% schaefer100x17
calm_qsiprep.schaefer100x17.coordinates = schaefer100x17_coordinates;
calm_qsiprep.schaefer100x17.connectivity = schaefer100x17;
calm_qsiprep.schaefer100x17.regionlabels = string(schaefer100x17_region_labels);
% schaefer100x7
calm_qsiprep.schaefer100x7.coordinates = schaefer100x7_coordinates;
calm_qsiprep.schaefer100x7.connectivity = schaefer100x7;
calm_qsiprep.schaefer100x7.regionlabels = string(schaefer100x7_region_labels);
% schaefer200x17
calm_qsiprep.schaefer200x17.coordinates = schaefer200x17_coordinates;
calm_qsiprep.schaefer200x17.connectivity = schaefer200x17;
calm_qsiprep.schaefer200x17.regionlabels = string(schaefer200x17_region_labels);
% schaefer200x7
calm_qsiprep.schaefer200x7.coordinates = schaefer200x7_coordinates;
calm_qsiprep.schaefer200x7.connectivity = schaefer200x7;
calm_qsiprep.schaefer200x7.regionlabels = string(schaefer200x7_region_labels);
% schaefer400x17
calm_qsiprep.schaefer400x17.coordinates = schaefer400x17_coordinates;
calm_qsiprep.schaefer400x17.connectivity = schaefer400x17;
calm_qsiprep.schaefer400x17.regionlabels = string(schaefer400x17_region_labels);
% schaefer400x7
calm_qsiprep.schaefer400x7.coordinates = schaefer400x7_coordinates;
calm_qsiprep.schaefer400x7.connectivity = schaefer400x7;
calm_qsiprep.schaefer400x7.regionlabels = string(schaefer400x7_region_labels);
% and save!
save('/imaging/projects/cbu/calm/calm_2_csd_ACT_qsiprep','calm_qsiprep','-v7.3');
